        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(flex: 1, child: Card(elevation: 0.1, color: Color(0xffF2F2F2) , child: Container(height: 250,padding: EdgeInsets.all(20),child: SingleChildScrollView(
                scrollDirection: Axis.vertical,
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Align(alignment:Alignment.center,child: Text(aslDescriptions[index],style:  Theme.of(context).textTheme.bodyLarge!.copyWith(fontSize: 17),)),
